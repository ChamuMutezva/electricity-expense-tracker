...
export default function AIInsightsTabs({ hasData }: Readonly<AIInsightsProps>) {
                                ...
                                <div className="mt-4 p-3 bg-gradient-to-r from-green-100 to-blue-100 dark:from-green-900 dark:to-blue-900 rounded text-sm">
                                    ...
                                    <ul className="list-disc list-inside mt-1 space-y-1">
                                        <li>
                                            ...
                                            Very generous free tier (15
                                            requests/minute)
                                        </li>
                                        <li>
                                            <strong>Latest AI</strong> -
                                            Google&apos;s most advanced AI model
                                        </li>
                                        <li>
                                            <strong>Reliable</strong> - Backed
                    ...
                    <TabsContent value="chat" className="space-y-4">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Ask questions about your electricity usage,
                                    get tips, and receive personalized advice
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                                {configError ? (
                                    <div className="text-center py-8">
                                        ...
                                        <p className="text-sm text-gray-400">
                                            Please configure your Google Gemini
                                            API key first
                                        </p>
                                    </div>
                                ) : (
